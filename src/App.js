...
function App() {
  ...
  return (
    ...
    <div style={{width: '100%', display: 'flex', flexDirection: 'row', justifyContent: 'space-around', flexWrap: 'wrap'}}>
      {/* first item div */}
      <div style={{ display: 'flex', height: '300px', overflow: 'auto',  maxWidth: '25%', justifyContent:'flex-end', alignItems: 'center',  background: 'linear-gradient(to right, #9effff6a, #a0ffa04b)', borderRadius: '70px', paddingRight: '10px', minWidth: '400px', width: 'calc(50% - 20px)'}}>
      ...
      {/* second item div */}
      <div style={{ display: 'flex', height: '300px', maxWidth: '25%', justifyContent:'flex-end', alignItems: 'center', background: 'linear-gradient(to right, #ffe2fc7e, #f4b6ff63)', borderRadius: '70px', paddingRight: '10px', minWidth: '400px', width: 'calc(50% - 20px)'}}>
      <div style={{marginLeft: '10px', marginRight: '10px', width: '100%', display: 'flex', justifyContent: 'center', flexDirection: 'column'}}>
      ...
      {/* third item div */}
      <div style={{display: 'flex', height: '300px', maxWidth: '25%', justifyContent:'flex-end', alignItems: 'center', background: 'linear-gradient(to right, #fff9e270, #ffefb673)', borderRadius: '70px', paddingRight: '10px', minWidth: '400px', width: 'calc(50% - 20px)'}}>
        <div style={{marginLeft: '10px', marginRight: '10px', width: '100%', display: 'flex', justifyContent: 'center', flexDirection: 'column'}}>
